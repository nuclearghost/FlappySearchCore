...
- (void) persistentStoreDidImportUbiquitousContentChanges:(NSNotification *)changeNotification
{
    ...
    NSLog(@"%@", changeNotification.userInfo.description);
    ...
    [moc performBlock:^{
        ...
        for (NSManagedObjectID *objID in allChanges) {
            ...
            NSLog( @"Object Changed from iCloud: %@",[self.managedObjectContext objectWithID:objID]);
        }
...
{
    NSLog(@"iCloud store did change with notfication:%@",notification);
...
- (void)startOver
{
    ...
    NSLog(@"ERROR | -startOver %@",[error localizedDescription]);
}
